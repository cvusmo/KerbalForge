...
public class KerbalForgePlugin : BaseSpaceWarpPlugin
{
    ...
    private const string ToolbarFlightButtonID = "BTN-KerbalForgeFlight";
    private const string ToolbarOABButtonID = "BTN-KerbalForgeOAB";

    public static KerbalForgePlugin Instance { get; set; }
    ...
    public override void OnInitialized()
    {
        ...
        Harmony.CreateAndPatchAll(typeof(KerbalForgePlugin).Assembly);
    ...
    {
        GUILayout.Label("KerbalForge - Reusable Re-Entry Systems");
